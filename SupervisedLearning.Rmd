...
boxEFI <- dataset %>%
  ...
  geom_hline(yintercept = mean(dataset$EFI), linetype = 2)+ 
  ylim(0, 100)+
  theme(legend.position="none") 

boxEFI

dfr <- data.frame(dataset, row.names = 1)
...
We see that europe stands well above the mean of the index, with the only exceptions of some eastern countries. 
